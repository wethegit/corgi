 ...
 *
 * This is a wrapper around LocaleContext. Technically this could all be
 * written within the LocaleContext file, but I find it easer to look at if
 * the developer-facing logic is isolated here.
 *
 * @example
 * -------
 ...
 * data, page-level locale data, any values defined in
 * config-locales.js localesMap, and alternativeLocales available for the current
 * page
 */
