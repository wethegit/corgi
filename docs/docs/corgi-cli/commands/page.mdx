...
```bash
npx @corgi/cli page About
```

```bash
npx @corgi/cli page About Work Contact
```
...
```bash
npx @corgi/cli page About --locales en es fr pt
```

## All together now…

```bash
npx @corgi/cli page About Work Contact Blog --locales en-us es-mx fr-ca
```
