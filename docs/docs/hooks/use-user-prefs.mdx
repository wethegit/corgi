...
The `useUserPrefs` hook gives us access to various user preferences, the values of which are stored in localStorage.
...
import useUserPrefs from "../../hooks/use-async";
