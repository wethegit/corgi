...
If you need static `.svg`, `.mp4`, or assets of other formats, add them to the default Next.js `/public/` directory. Just remember not to tamper with the generated `/public/_images/` directory within.
