...
All sub-pages live within the `/src/pages/[locale]/<sub-page-name>` directory, and expect an index.js file as their source. (`<sub-page-name>` should be replaced with the name of your page, so `/src/pages/[locale]/about`, for example).
